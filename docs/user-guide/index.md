...
This user guide provides comprehensive information about using and understanding the Agentic FastAPI Template. Whether you're building your first AI agent or looking to understand enterprise features, this guide covers everything you need to know.

## What You'll Learn

This guide covers all aspects of working with the Agentic FastAPI Template:
...
### 🤖 Agentic AI Features
- **[Agentic Overview](../agents/README.md)** - Comprehensive guide to the agentic framework
- **[LangGraph Agents](../agents/README.md#agent-orchestration-with-langgraph)** - Building and orchestrating AI agents
- **[RAG Pipeline](../agents/README.md#retrieval-augmented-generation-rag)** - Ingesting and querying enterprise knowledge
- **[Enterprise Integrations](../agents/README.md#enterprise-integrations-oauth2)** - Jira, Confluence, and SharePoint integrations
- **[Resilience & Rate Limiting](../agents/README.md#resilience-patterns)** - Production-ready reliability
