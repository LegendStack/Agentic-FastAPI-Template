...
Welcome to the Agentic FastAPI Template! This guide will have you up and running with a production-ready agentic AI API in just a few minutes.
...
1. Click **"Use this template"** on the [GitHub repository](https://github.com/LegendStack/agentic-fastapi-template)
...
```env
# Application
APP_NAME="Agentic FastAPI Template"
APP_DESCRIPTION="My awesome agentic API"
APP_VERSION="2.1.0"
...
```
agentic-fastapi-template-web-1     | INFO:     Application startup complete.
agentic-fastapi-template-db-1      | database system is ready to accept connections
agentic-fastapi-template-worker-1  | redis_version=7.x.x mem_usage=1MB clients_connected=1
```
...
- RAG system with pgvector/Azure Search
...
- Report issues on **[GitHub](https://github.com/LegendStack/agentic-fastapi-template/issues)**
