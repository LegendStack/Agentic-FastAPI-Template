# Contributing to Agentic FastAPI Template

Thank you for your interest in contributing to Agentic FastAPI Template! This guide is meant to make it easy for you to get started.
...
Agentic FastAPI Template uses uv for managing dependencies. If you don't have uv installed, follow the instructions on the [official uv website](https://docs.astral.sh/uv/).
...
Agentic FastAPI Template uses pytest for testing. Run tests using:
...
Thank you for contributing to Agentic FastAPI Template🚀
