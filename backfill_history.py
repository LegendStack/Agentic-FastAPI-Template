...
from src.app.models.agentic import LangGraphCheckpoint, Conversation
...
async def backfill():
    async for db in async_get_db():
        ...
        for thread_id in thread_ids:
            ...
            stmt_latest = select(LangGraphCheckpoint).where(
                LangGraphCheckpoint.thread_id == thread_id
            ).order_by(LangGraphCheckpoint.checkpoint_id.desc()).limit(1)
