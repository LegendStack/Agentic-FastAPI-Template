...
from src.app.agents.backlog.schemas import AcceptanceCriteria, DecompositionResult, Epic, UserStory
...
async def test_auto_epic_creation():
    ...
    config = BacklogAgentConfig(
        ENABLE_JIRA_EXPORT=True, JIRA_EPIC_LINK_FIELD="customfield_10014", JIRA_EPIC_NAME_FIELD="customfield_10011"
    )
    ...
    stories = [
        UserStory(
            id="S1", title="Story 1", description="Desc 1", acceptance_criteria=[AcceptanceCriteria(description="AC1")]
        ),
    ]
