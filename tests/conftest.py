...
# Prevent real connections during tests
...
patch("src.app.core.setup.create_redis_cache_pool", return_value=None).start()
patch("src.app.core.setup.create_redis_queue_pool", return_value=None).start()
patch("src.app.core.setup.create_redis_rate_limit_pool", return_value=None).start()
patch("src.app.core.setup.create_tables", return_value=None).start()
